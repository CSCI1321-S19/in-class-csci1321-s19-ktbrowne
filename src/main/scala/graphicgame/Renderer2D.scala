...
class Renderer2D(gc: GraphicsContext, blockSize: Double) {
  ...
  private val floorImage = Renderer2D.loadImage("floor.png")
  private val wallImage = Renderer2D.loadImage("wall.png")
  private val playerImage = Renderer2D.loadImage("player.png")
